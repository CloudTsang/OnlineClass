...
:: Android packaging
set AND_CERT_NAME="StudentSide"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\StudentSide.p12
...
set IOS_PROVISION=cert\StudentSide.mobileprovision
...
set APP_XML=src\StudentSide-app.xml
